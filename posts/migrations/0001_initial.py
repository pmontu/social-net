# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-11 05:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_by_users', models.ManyToManyField(related_name='posts_liked', through='posts.Like', to=settings.AUTH_USER_MODEL)),
